...
Report::Report(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Report),m_progressDialog(0)
{
    ui->setupUi(this);
    this->showNormal();
...
void Report::setDatabase(QString invoiceNumber)
{
    //read setting file
...
void Report::on_pushButtonPreview_clicked()
{
...
void Report::renderPageFinished(int renderedPageCount)
{
    if (m_progressDialog){
