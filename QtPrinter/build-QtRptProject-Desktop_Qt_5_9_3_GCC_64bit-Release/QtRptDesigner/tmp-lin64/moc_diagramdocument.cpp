...
#include "../../../QtRptProject/QtRptDesigner/SQLDiagram/diagramdocument.h"
...
void DiagramDocument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramDocument::modeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramDocument::sqlChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject DiagramDocument::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_DiagramDocument.data,
      qt_meta_data_DiagramDocument,  qt_static_metacall, nullptr, nullptr}
};
