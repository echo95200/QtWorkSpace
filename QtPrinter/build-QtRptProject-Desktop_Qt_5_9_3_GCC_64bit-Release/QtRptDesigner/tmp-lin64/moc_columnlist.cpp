...
#include "../../../QtRptProject/QtRptDesigner/SQLDiagram/columnlist.h"
...
void ColumnList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnList::columnAboutToBeInserted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColumnList::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnList::columnInserted)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColumnList::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnList::columnAboutToBeRemoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (ColumnList::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnList::columnRemoved)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (ColumnList::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnList::columnChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject ColumnList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ColumnList.data,
      qt_meta_data_ColumnList,  qt_static_metacall, nullptr, nullptr}
};
