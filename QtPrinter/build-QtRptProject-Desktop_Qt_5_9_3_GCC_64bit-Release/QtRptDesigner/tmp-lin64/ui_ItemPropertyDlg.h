...
public:
    ...
    {
        ItemPropertyDlg->setWindowTitle(QApplication::translate("ItemPropertyDlg", "Object property", Q_NULLPTR));
        label->setText(QApplication::translate("ItemPropertyDlg", "Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ItemPropertyDlg", "Name", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("ItemPropertyDlg", "Relation property", Q_NULLPTR));
        label_3->setText(QApplication::translate("ItemPropertyDlg", "Parent table", Q_NULLPTR));
        label_4->setText(QApplication::translate("ItemPropertyDlg", "Columns:", Q_NULLPTR));
        label_5->setText(QApplication::translate("ItemPropertyDlg", "reference", Q_NULLPTR));
        label_2->setText(QApplication::translate("ItemPropertyDlg", "Child table", Q_NULLPTR));
        btnOK->setText(QApplication::translate("ItemPropertyDlg", "OK", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ItemPropertyDlg", "Close", Q_NULLPTR));
    } // retranslateUi
