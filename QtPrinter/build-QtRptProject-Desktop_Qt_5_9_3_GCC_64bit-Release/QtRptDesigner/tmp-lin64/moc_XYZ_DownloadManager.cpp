...
#include "../../../QtRptProject/CommonFiles/XYZ_DownloadManager.h"
...
void XYZDownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&XYZDownloadManager::done)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&XYZDownloadManager::downloadingProgress)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject XYZDownloadManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XYZDownloadManager.data,
      qt_meta_data_XYZDownloadManager,  qt_static_metacall, nullptr, nullptr}
};
