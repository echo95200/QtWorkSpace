...
public:
    ...
    {
        ExampleDlg5->setWindowTitle(QApplication::translate("ExampleDlg5", "Dialog", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExampleDlg5", "Goods", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExampleDlg5", "Quant", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExampleDlg5", "Price", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExampleDlg5", "Sum", Q_NULLPTR));
        btnPrint->setText(QApplication::translate("ExampleDlg5", "Print", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg5", "Close", Q_NULLPTR));
    } // retranslateUi
