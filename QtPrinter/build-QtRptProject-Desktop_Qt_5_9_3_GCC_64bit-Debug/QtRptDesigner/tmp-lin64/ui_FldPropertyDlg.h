...
public:
    ...
    {
        FldPropertyDlg->setWindowTitle(QApplication::translate("FldPropertyDlg", "Expression editor", Q_NULLPTR));
        label->setText(QApplication::translate("FldPropertyDlg", "Data filed grouping", Q_NULLPTR));
        chkStartLineNum->setText(QApplication::translate("FldPropertyDlg", "Start line numeration for each group", Q_NULLPTR));
        chkStartNewPage->setText(QApplication::translate("FldPropertyDlg", "Start new page for each group", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("FldPropertyDlg", "Category", Q_NULLPTR));
        ...
        ___qlistwidgetitem->setText(QApplication::translate("FldPropertyDlg", "Number", Q_NULLPTR));
        lstCategory->setSortingEnabled(__sortingEnabled);

        groupBox_2->setTitle(QApplication::translate("FldPropertyDlg", "Format", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("FldPropertyDlg", "Other", Q_NULLPTR));
        label_2->setText(QApplication::translate("FldPropertyDlg", "Precision", Q_NULLPTR));
        label_3->setText(QApplication::translate("FldPropertyDlg", "Format string", Q_NULLPTR));
        btnClear->setText(QApplication::translate("FldPropertyDlg", "Clear", Q_NULLPTR));
        btnOK->setText(QApplication::translate("FldPropertyDlg", "OK", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("FldPropertyDlg", "Cancel", Q_NULLPTR));
    } // retranslateUi
