...
#include "../../../QtRptProject/QtRptDesigner/mainwindow.h"
...
void EditorDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorDelegate::editorClose)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorDelegate::btnClicked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject EditorDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_EditorDelegate.data,
      qt_meta_data_EditorDelegate,  qt_static_metacall, nullptr, nullptr}
};
