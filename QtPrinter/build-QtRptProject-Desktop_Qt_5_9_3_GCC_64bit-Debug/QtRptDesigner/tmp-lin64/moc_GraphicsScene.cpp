...
#include "../../../QtRptProject/QtRptDesigner/Graphics/GraphicsScene.h"
...
void GraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsScene::mousePos)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsScene::sceneModeChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            typedef void (GraphicsScene::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsScene::itemAdded)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (GraphicsScene::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsScene::itemResized)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsScene::sceneClick)) {
                *result = 5;
                return;
            }
        }
