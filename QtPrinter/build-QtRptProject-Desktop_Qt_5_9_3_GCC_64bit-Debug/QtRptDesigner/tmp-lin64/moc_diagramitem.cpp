...
#include "../../../QtRptProject/QtRptDesigner/SQLDiagram/diagramitem.h"
...
void DiagramItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramItem::propertyChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DiagramItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DiagramItem.data,
      qt_meta_data_DiagramItem,  qt_static_metacall, nullptr, nullptr}
};
