...
public:
    ...
    {
        ExampleDlg6->setWindowTitle(QApplication::translate("ExampleDlg6", "Example 6", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExampleDlg6", "Market", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExampleDlg6", "Goods", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExampleDlg6", "Quantity", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExampleDlg6", "Price", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("ExampleDlg6", "Sum", Q_NULLPTR));
        btnPrint->setText(QApplication::translate("ExampleDlg6", "Print", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg6", "Close", Q_NULLPTR));
    } // retranslateUi
