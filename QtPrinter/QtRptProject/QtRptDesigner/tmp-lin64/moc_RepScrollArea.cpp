...
QT_MOC_LITERAL(1, 14, 10), // "bandResing"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "showGrid"
QT_MOC_LITERAL(4, 35, 5), // "value"
QT_MOC_LITERAL(5, 41, 4) // "rect"

    },
    "RepScrollArea\0bandResing\0\0showGrid\0"
    "value\0rect"
};
...
void RepScrollArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bandResing((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->showGrid((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->bandResing((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (RepScrollArea::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RepScrollArea::bandResing)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void RepScrollArea::bandResing(int _t1)
{
