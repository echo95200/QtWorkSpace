...
#include "../SQLDiagram/diagramobject.h"
...
const QMetaObject DiagramObject::staticMetaObject = {
    { &DiagramItem::staticMetaObject, qt_meta_stringdata_DiagramObject.data,
      qt_meta_data_DiagramObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DiagramObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DiagramObject.stringdata0))
        return static_cast<void*>(const_cast< DiagramObject*>(this));
