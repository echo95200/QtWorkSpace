...
#include "../../CommonFiles/updatedlg.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UpdateDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UpdateDlg_t qt_meta_stringdata_UpdateDlg = {
    {
QT_MOC_LITERAL(0, 0, 9), // "UpdateDlg"
QT_MOC_LITERAL(1, 10, 10), // "doDownload"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16), // "downloadProgress"
QT_MOC_LITERAL(4, 39, 8), // "recieved"
QT_MOC_LITERAL(5, 48, 5) // "total"

    },
    "UpdateDlg\0doDownload\0\0downloadProgress\0"
    "recieved\0total"
};
...
void *UpdateDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UpdateDlg.stringdata))
