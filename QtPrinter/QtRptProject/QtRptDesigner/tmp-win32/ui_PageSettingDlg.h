...
public:
    ...
    {
        PageSettingDlg->setWindowTitle(QApplication::translate("PageSettingDlg", "Page settings", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("PageSettingDlg", "Size", Q_NULLPTR));
        cbPageSize->clear();
        cbPageSize->insertItems(0, QStringList()
         << QApplication::translate("PageSettingDlg", "A3", Q_NULLPTR)
         << QApplication::translate("PageSettingDlg", "A4", Q_NULLPTR)
         << QApplication::translate("PageSettingDlg", "A5", Q_NULLPTR)
         << QApplication::translate("PageSettingDlg", "Letter", Q_NULLPTR)
        );
        label_10->setText(QApplication::translate("PageSettingDlg", "Width", Q_NULLPTR));
        label_12->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        label_11->setText(QApplication::translate("PageSettingDlg", "Height", Q_NULLPTR));
        label_13->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("PageSettingDlg", "Orientation", Q_NULLPTR));
        rPortrait->setText(QApplication::translate("PageSettingDlg", "Portrait", Q_NULLPTR));
        rLandscape->setText(QApplication::translate("PageSettingDlg", "Landscape", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("PageSettingDlg", "Margins", Q_NULLPTR));
        label_3->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        label_4->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        label_5->setText(QApplication::translate("PageSettingDlg", "Left", Q_NULLPTR));
        label_7->setText(QApplication::translate("PageSettingDlg", "Right", Q_NULLPTR));
        label_8->setText(QApplication::translate("PageSettingDlg", "Bottom", Q_NULLPTR));
        label->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        label_2->setText(QApplication::translate("PageSettingDlg", "cm", Q_NULLPTR));
        label_6->setText(QApplication::translate("PageSettingDlg", "Top", Q_NULLPTR));
        groupBox_41->setTitle(QApplication::translate("PageSettingDlg", "Page border", Q_NULLPTR));
        chkDrawBorder->setText(QApplication::translate("PageSettingDlg", "Draw border", Q_NULLPTR));
        label_14->setText(QApplication::translate("PageSettingDlg", "Border color", Q_NULLPTR));
        lblBorderColor->setText(QString());
        btnBorderColor->setText(QApplication::translate("PageSettingDlg", "...", Q_NULLPTR));
        label_9->setText(QApplication::translate("PageSettingDlg", "Border width", Q_NULLPTR));
        label_15->setText(QApplication::translate("PageSettingDlg", "Border style", Q_NULLPTR));
        btnOK->setText(QApplication::translate("PageSettingDlg", "OK", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("PageSettingDlg", "Cancel", Q_NULLPTR));
    } // retranslateUi
