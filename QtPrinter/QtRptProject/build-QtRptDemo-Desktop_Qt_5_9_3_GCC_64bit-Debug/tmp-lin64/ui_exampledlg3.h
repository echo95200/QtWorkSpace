...
public:
    ...
    {
        ExampleDlg3->setWindowTitle(QApplication::translate("ExampleDlg3", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("ExampleDlg3", "First name", Q_NULLPTR));
        label_2->setText(QApplication::translate("ExampleDlg3", "Last Name", Q_NULLPTR));
        label_3->setText(QApplication::translate("ExampleDlg3", "E-mail", Q_NULLPTR));
        btnUpdatePreview->setText(QApplication::translate("ExampleDlg3", "Update preview", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg3", "Close", Q_NULLPTR));
    } // retranslateUi
