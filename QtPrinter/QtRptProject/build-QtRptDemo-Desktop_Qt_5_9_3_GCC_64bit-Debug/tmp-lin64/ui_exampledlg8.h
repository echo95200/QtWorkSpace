...
public:
    ...
    {
        ExampleDlg8->setWindowTitle(QApplication::translate("ExampleDlg8", "Dialog", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExampleDlg8", "No", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExampleDlg8", "Text", Q_NULLPTR));
        btnPrint->setText(QApplication::translate("ExampleDlg8", "Print", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg8", "Close", Q_NULLPTR));
    } // retranslateUi
