...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "QtRPT examples", Q_NULLPTR));
        actionPrint->setText(QApplication::translate("MainWindow", "Print", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("MainWindow", "Select example", Q_NULLPTR));
        rBtn1->setText(QApplication::translate("MainWindow", "Invoice report (data from grid)", Q_NULLPTR));
        rBtn2->setText(QApplication::translate("MainWindow", "Two datasource report", Q_NULLPTR));
        rBtn3->setText(QApplication::translate("MainWindow", "Embedded report widget", Q_NULLPTR));
        rBtn4->setText(QApplication::translate("MainWindow", "Report with condition (Printable and highlighting fields)", Q_NULLPTR));
        rBtn5->setText(QApplication::translate("MainWindow", "Report with mathematics and aggregate functions", Q_NULLPTR));
        rBtn6a->setText(QApplication::translate("MainWindow", "Report with grouping data in Master Data Band 1", Q_NULLPTR));
        rBtn6b->setText(QApplication::translate("MainWindow", "Report with grouping data in Master Data Band 2", Q_NULLPTR));
        rBtn7->setText(QApplication::translate("MainWindow", "Report with Diagram", Q_NULLPTR));
        rBtn8->setText(QApplication::translate("MainWindow", "Report with AutoHeight", Q_NULLPTR));
        rBtn9->setText(QApplication::translate("MainWindow", "Report with Drawing", Q_NULLPTR));
        rBtn10->setText(QApplication::translate("MainWindow", "Report with SQL query to SQLITE DB", Q_NULLPTR));
        rBtn11->setText(QApplication::translate("MainWindow", "Barcode generator", Q_NULLPTR));
        rBtn12->setText(QApplication::translate("MainWindow", "Report with RichText Fields", Q_NULLPTR));
        rBtnRussian->setText(QApplication::translate("MainWindow", "Russian invaders", Q_NULLPTR));
        rBtn13->setText(QApplication::translate("MainWindow", "Report's control from user application", Q_NULLPTR));
        rBtn14->setText(QApplication::translate("MainWindow", "Creation of the report from the user application without XML file", Q_NULLPTR));
        rBtn15->setText(QApplication::translate("MainWindow", "Generate PDF file", Q_NULLPTR));
        rBtn16->setText(QApplication::translate("MainWindow", "Application defined SQL parameters and images from SQLITE DB table", Q_NULLPTR));
        rBtn17->setText(QApplication::translate("MainWindow", "Buil in functions and system variables", Q_NULLPTR));
        rBtn18->setText(QApplication::translate("MainWindow", "CrossTab report", Q_NULLPTR));
        label->setText(QString());
        btnShow->setText(QApplication::translate("MainWindow", "Show", Q_NULLPTR));
    } // retranslateUi
