...
public:
    ...
    {
        ExampleDlg1->setWindowTitle(QApplication::translate("ExampleDlg1", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("ExampleDlg1", "Customer", Q_NULLPTR));
        label_2->setText(QApplication::translate("ExampleDlg1", "Date", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExampleDlg1", "Goods", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExampleDlg1", "Quantity", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExampleDlg1", "Price", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExampleDlg1", "Sum", Q_NULLPTR));
        btnPrint->setText(QApplication::translate("ExampleDlg1", "Print", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg1", "Close", Q_NULLPTR));
    } // retranslateUi
