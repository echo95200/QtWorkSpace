...
public:
    ...
    {
        ExampleDlg2->setWindowTitle(QApplication::translate("ExampleDlg2", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("ExampleDlg2", "First data source", Q_NULLPTR));
        label_2->setText(QApplication::translate("ExampleDlg2", "Second data source", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = table1->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExampleDlg2", "\320\235\320\276\320\262\321\213\320\271 \321\201\321\202\320\276\320\273\320\261\320\265\321\206", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = table2->horizontalHeaderItem(0);
        ___qtablewidgetitem1->setText(QApplication::translate("ExampleDlg2", "\320\235\320\276\320\262\321\213\320\271 \321\201\321\202\320\276\320\273\320\261\320\265\321\206", Q_NULLPTR));
        label_3->setText(QApplication::translate("ExampleDlg2", "Two datasource example", Q_NULLPTR));
        btnPrint->setText(QApplication::translate("ExampleDlg2", "Print", Q_NULLPTR));
        btnClose->setText(QApplication::translate("ExampleDlg2", "Close", Q_NULLPTR));
    } // retranslateUi
